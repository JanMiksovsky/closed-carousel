...
function DarkModeMixin(Base) {
  return class dark extends Base {
     ...
     */
    get dark() {
      return this[state$1].dark;
    }
    set dark(dark) {
      this[setState$1]({ dark });
    }
    ...
    [rendered$1](changed) {
      ...
      if (changed.detectDarkMode) {
        const { detectDarkMode } = this[state$1];
...
function DelegateInputLabelMixin(Base) {
  ...
  class DelegateInputLabel extends Base {
    ...
    get ariaLabel() {
      return this[state$1].ariaLabel;
    }
    set ariaLabel(ariaLabel) {
      this[setState$1]({ ariaLabel });
    }
...
function FocusVisibleMixin(Base) {
  ...
  return class FocusVisible extends Base {
    ...
    get [template$1]() {
      const result = super[template$1] || templateFrom.html``;
...
class WrappedStandardElement extends Base {
  ...
  attributeChangedCallback(name, oldValue, newValue) {
    ...
    if (forwardAttribute) {
      const innerAttributes = Object.assign({}, this[state$1].innerAttributes, {
        [name]: newValue,
      });
  ...
  [render$1](/** @type {ChangedFlags} */ changed) {
    ...
    this.constructor[delegatedPropertySettersKey].forEach((property) => {
      if (changed[property]) {
        const value = this[state$1][property];
  ...
  setInnerProperty(name, value) {
    ...
    if (this[state$1][name] !== value) {
      this[setState$1]({ [name]: value });
    }
  }
...
const Base$2 = DarkModeMixin(PlainButton);
 ...
 * @mixes DarkModeMixin
 */
class PlainArrowDirectionButton extends Base$2 {
  get [template$1]() {
    const result = super[template$1];
    result.content.append(
      fragmentFrom.html`
  ...
  class AriaList extends Base {
    ...
    [render$1](/** @type {ChangedFlags} */ changed) {
      ...
      if (changed.items || changed.selectedIndex || changed.selectedItemFlags) {
        ...
        const { selectedItemFlags, selectedIndex } = this[state$1];
        if (items) {
      ...
      if (changed.items || changed.selectedIndex) {
        const { selectedIndex } = this[state$1];
        const selectedItem =
      ...
      if (changed.selectedItemFlags) {
        ...
        if (this[state$1].selectedItemFlags) {
      ...
      if (changed.orientation) {
        const { orientation } = this[state$1];
...
function ArrowDirectionMixin(Base) {
  ...
  class ArrowDirection extends Base {
    ...
    get arrowButtonOverlap() {
      return this[state$1].arrowButtonOverlap;
    }
    set arrowButtonOverlap(arrowButtonOverlap) {
      this[setState$1]({ arrowButtonOverlap });
    }
    ...
    get arrowButtonPartType() {
      return this[state$1].arrowButtonPartType;
    }
    set arrowButtonPartType(arrowButtonPartType) {
      this[setState$1]({ arrowButtonPartType });
    }
    ...
    [render$1](/** @type {ChangedFlags} */ changed) {
      if (changed.arrowButtonPartType) {
        const arrowButtonPrevious = this[ids$1].arrowButtonPrevious;
        ...
        const arrowButtonNext = this[ids$1].arrowButtonNext;
      ...
      /** @type {any} */ const arrowButtonPrevious = this[ids$1]
        .arrowButtonPrevious;
      /** @type {any} */ const arrowButtonNext = this[ids$1].arrowButtonNext;
      ...
      if (
        ...
        this[ids$1].arrowDirection.style.flexDirection = vertical
          ? "column"
          : "row";
      ...
      if (changed.showArrowButtons) {
        const display = this[state$1].showArrowButtons ? null : "none";
    ...
    get showArrowButtons() {
      return this[state$1].showArrowButtons;
    }
    set showArrowButtons(showArrowButtons) {
      this[setState$1]({ showArrowButtons });
    }
    ...
    [wrap](target) {
      ...
      renderParts(arrowControls, this[state$1]);
...
function CursorAPIMixin(Base) {
  ...
  class CursorAPI extends Base {
     ...
     */
    get currentIndex() {
      const { items, currentIndex } = this[state$1];
      return items && items.length > 0 ? currentIndex : -1;
    }
    set currentIndex(currentIndex) {
      if (!isNaN(currentIndex)) {
        this[setState$1]({ currentIndex });
      }
    }
    ...
    get currentItemRequired() {
      return this[state$1].currentItemRequired;
    }
    set currentItemRequired(currentItemRequired) {
      this[setState$1]({ currentItemRequired });
    }
    ...
    get cursorOperationsWrap() {
      return this[state$1].cursorOperationsWrap;
    }
    set cursorOperationsWrap(cursorOperationsWrap) {
      this[setState$1]({ cursorOperationsWrap });
    }
    ...
    [rendered$1](/** @type {ChangedFlags} */ changed) {
      ...
      if (changed.currentIndex && this[raiseChangeEvents$1]) {
        const { currentIndex } = this[state$1];
...
function ItemsAPIMixin(Base) {
  ...
  class ItemsAPI extends Base {
    ...
    [rendered$1](/** @type {ChangedFlags} */ changed) {
      ...
      // activity.
      if (!this[firstRender$1] && changed.items && this[raiseChangeEvents$1]) {
...
function ItemsCursorMixin(Base) {
  ...
  class ItemsCursor extends Base {
    ...
    [goLast]() {
      ...
      return moveToIndex(this, this[state$1].items.length - 1, -1);
    }
    ...
    [goNext]() {
      ...
      const { currentIndex, items } = this[state$1];
...
function moveToIndex(element, index, direction) {
  const newIndex = element[closestAvailableItemIndex](element[state$1], {
    direction,
    index,
  });
  if (newIndex < 0) {
  ...
  const changed = element[state$1].currentIndex !== newIndex;
  if (changed) {
    element[setState$1]({
      currentIndex: newIndex,
    });
...
function CursorInViewMixin(Base) {
  ...
  class CursorInView extends Base {
    ...
    scrollCurrentItemIntoView() {
      ...
      const { currentItem, items } = this[state$1];
...
function FormElementMixin(Base) {
  ...
  class FormElement extends Base {
    ...
    [rendered$1](/** @type {ChangedFlags} */ changed) {
      ...
      if (changed.value) {
        if (this[nativeInternals$1]) {
          this[nativeInternals$1].setFormValue(this[state$1].value, this[state$1]);
        }
      }
    }
...
function KeyboardPagedCursorMixin(Base) {
  ...
  class KeyboardPagedCursor extends Base {
    ...
    get orientation() {
      return (
        super.orientation || (this[state$1] && this[state$1].orientation) || "both"
      );
    }
...
function getIndexOfItemAtY(element, y, downward) {
  ...
  let itemRect;
  const { availableItemFlags } = element[state$1];
...
function scrollOnePage(element, downward) {
  const items = element[state$1].items;
  const currentIndex = element[state$1].currentIndex;
  ...
  if (!newIndex) {
    ...
    newIndex = element[closestAvailableItemIndex]
      ? element[closestAvailableItemIndex](element[state$1], {
...
function KeyboardPrefixCursorMixin(Base) {
  ...
  class KeyboardPrefixCursor extends Base {
    ...
    [goToItemWithPrefix](prefix) {
      ...
      if (index >= 0) {
        const previousIndex = this[state$1].currentIndex;
        this[setState$1]({ currentIndex: index });
        return this[state$1].currentIndex !== previousIndex;
      } else {
        return false;
      }
    }
...
function SelectedTextAPIMixin(Base) {
  ...
  class SelectedTextAPI extends Base {
    ...
    [rendered$1](/** @type {ChangedFlags} */ changed) {
      ...
      const { items, desiredSelectedText } = this[state$1];
...
function SelectedValueAPIMixin(Base) {
  ...
  class SelectedValueAPI extends Base {
    ...
    [rendered$1](/** @type {ChangedFlags} */ changed) {
      ...
      // value.
      const { items, desiredValue } = this[state$1];
...
function SingleSelectAPIMixin(Base) {
  ...
  class SingleSelectAPI extends Base {
    ...
    set selectedItem(selectedItem) {
      ...
      if (index >= 0) {
        this[setState$1]({ selectedIndex: index });
      }
    }
  }
  ...
  class SlotContent extends Base {
    ...
    get [contentSlot]() {
      /** @type {HTMLSlotElement|null} */ const slot =
        this[shadowRoot$1] && this[shadowRoot$1].querySelector("slot:not([name])");
...
function TapCursorMixin(Base) {
  ...
  return class TapCursor extends Base {
    ...
    [tap](/** @type {MouseEvent} */ event) {
      ...
      const { items, currentItemRequired } = this[state$1];
...
class ListBox extends Base$3 {
  ...
  get orientation() {
    return this[state$1].orientation;
  }
  set orientation(orientation) {
    this[setState$1]({ orientation });
  }
  ...
  [render$1](/** @type {ChangedFlags} */ changed) {
    ...
    if (changed.orientation) {
      ...
      const style =
        this[state$1].orientation === "vertical"
          ? {
              display: "block",
              flexDirection: "",
              overflowX: "hidden",
      ...
      Object.assign(this[ids$1].container.style, style);
    }
  }

  get [scrollTarget]() {
    return this[ids$1].container;
  }
...
class Explorer extends Base$5 {
   ...
   */
  get canGoPrevious() {
    return this[state$1].canGoPrevious;
  }
  ...
  [checkSize]() {
    ...
    if (this[ids$1].stage[checkSize]) {
      this[ids$1].stage[checkSize]();
    }
    if (this[ids$1].proxyList[checkSize]) {
      this[ids$1].proxyList[checkSize]();
    }
  }
  ...
  [render$1](/** @type {ChangedFlags} */ changed) {
    ...
    if (this[firstRender$1]) {
      ...
      this[ids$1].proxySlot.addEventListener("slotchange", () => {
        const proxySlot = /** @type {any} */ (this[ids$1].proxySlot);
        ...
        if (proxiesAssigned) {
          ...
          this[setState$1]({ proxiesAssigned });
        }
      });
    }
    ...
    if (changed.proxyListPartType) {
      this[ids$1].proxyList.addEventListener(
        "selectedindexchange",
    ...
    if (changed.stagePartType) {
      this[ids$1].stage.addEventListener(
        "selectedindexchange",
        handleSelectedIndexChanged
      );
      this[ids$1].stage.addEventListener("selectioneffectend", (event) => {
    ...
    const proxyList = this[ids$1].proxyList;
    const stage = this[ids$1].stage;
    if (changed.proxies || changed.proxiesAssigned) {
      // Render the default proxies.
      const { proxies, proxiesAssigned } = this[state$1];
      const childNodes = proxiesAssigned
        ? [this[ids$1].proxySlot]
        : [this[ids$1].proxySlot, ...proxies];
      updateChildNodes(this[ids$1].proxyList, childNodes);
    }
    ...
    if (
      ...
      const { proxyListOverlap, proxyListPosition } = this[state$1];
    ...
    if (changed.proxyListPosition || changed.rightToLeft) {
      ...
      if ("position" in cast) {
        const { proxyListPosition, rightToLeft } = this[state$1];
        let position;
    ...
    if (changed.proxyListPosition || changed.proxyListPartType) {
      setListAndStageOrder(this, this[state$1]);
      const { proxyListPosition } = this[state$1];
      const lateralPosition = lateralPositions[proxyListPosition];
      this[ids$1].explorerContainer.style.flexDirection = lateralPosition
        ? "row"
        : "column";
      Object.assign(proxyList.style, {
    ...
    if (changed.currentItemRequired || changed.proxyListPartType) {
      if ("selectionRequired" in proxyList) {
        const { selectionRequired } = this[state$1];
    ...
    if (changed.swipeFraction || changed.proxyListPartType) {
      if ("swipeFraction" in proxyList) {
        const { swipeFraction } = this[state$1];
  ...
  get proxyListOverlap() {
    return this[state$1].proxyListOverlap;
  }
  set proxyListOverlap(proxyListOverlap) {
    this[setState$1]({ proxyListOverlap });
  }
  ...
  get proxyListPosition() {
    return this[state$1].proxyListPosition;
  }
  set proxyListPosition(proxyListPosition) {
    this[setState$1]({ proxyListPosition });
  }
  ...
  get proxyListPartType() {
    return this[state$1].proxyListPartType;
  }
  set proxyListPartType(proxyListPartType) {
    this[setState$1]({ proxyListPartType });
  }
   ...
   */
  get proxyPartType() {
    return this[state$1].proxyPartType;
  }
  set proxyPartType(proxyPartType) {
    this[setState$1]({ proxyPartType });
  }
   ...
   */
  get stagePartType() {
    return this[state$1].stagePartType;
  }
  set stagePartType(stagePartType) {
    this[setState$1]({ stagePartType });
  }
...
function setListAndStageOrder(element, state) {
  ...
  const container = element[ids$1].explorerContainer;
  const stage = findChildContainingNode(container, element[ids$1].stage);
  const list = findChildContainingNode(container, element[ids$1].proxyList);
  ...
  if (firstElement && lastElement) {
    ...
    if (nextElementSibling !== lastElement) {
      element[ids$1].explorerContainer.insertBefore(firstElement, lastElement);
    }
  }
}
  ...
  class Transition extends Base {
    ...
    [rendered$1](/** @type {ChangedFlags} */ changed) {
      ...
      if (this[firstRender$1]) {
        ...
        setTimeout(() => {
          this[setState$1]({ enableEffects: true });
        });
      }
    }
  }
 ...
 * @mixes SlotItemsMixin
 */
class SlidingStage extends Base$6 {
  attributeChangedCallback(name, oldValue, newValue) {
  ...
  [render$1](/** @type {ChangedFlags} */ changed) {
    ...
    if (
      ...
      const { orientation, rightToLeft, currentIndex, items } = this[state$1];
      const vertical = orientation === "vertical";
      const sign = vertical ? -1 : rightToLeft ? 1 : -1;
      const swiping = this[state$1].swipeFraction != null;
      const swipeFraction = this[state$1].swipeFraction || 0;
      let translation;
      if (currentIndex >= 0) {
      ...
      const slidingStageContent = this[ids$1].slidingStageContent;
      const axis = vertical ? "Y" : "X";
      slidingStageContent.style.transform = `translate${axis}(${translation}%)`;

      const showTransition = this[state$1].enableEffects && !swiping;
    ...
    if (changed.orientation) {
      const { orientation } = this[state$1];
      const vertical = orientation === "vertical";
      this[ids$1].slidingStageContent.style.flexDirection = vertical
        ? "column"
        : "";
    }
  }
  ...
  get swipeFraction() {
    return this[state$1].swipeFraction;
  }
  set swipeFraction(swipeFraction) {
    this[setState$1]({ swipeFraction });
  }
...
function gestureContinue(element, clientX, clientY, eventTarget) {
  ...
  const { swipeAxis, swipeFractionMax, swipeFractionMin } = element[state$1];
  ...
  if (element[state$1].swipeFraction === swipeFraction) {
  ...
  element[setState$1]({ swipeFraction });
...
function gestureEnd(element, clientX, clientY, eventTarget) {
  ...
  const { swipeAxis, swipeFraction } = element[state$1];
  ...
  if (!willScroll) {
    ...
    if (velocity >= flickThresholdVelocity && swipeFraction >= 0) {
      ...
      if (
        element[state$1].swipeLeftWillCommit ||
        element[state$1].swipeUpWillCommit
      ) {
        flickPositive = false;
      } else if (
        element[state$1].swipeRightWillCommit ||
        element[state$1].swipeDownWillCommit
      ) {
        flickPositive = true;
      }
    }
...
function getSwipeFraction(element, x, y) {
  const { swipeAxis } = element[state$1];
  /** @type {any} */ const cast = element;
  const vertical = swipeAxis === "vertical";
...
function handleWheel(element, event) {
  ...
  cast[lastWheelTimeoutKey] = setTimeout(async () => {
    ...
    await Promise.resolve();
    cast[raiseChangeEvents$1] = false;
  }, WHEEL_TIME);
...
async function wheelTimedOut(element) {
  // If the user swiped far enough to commit a gesture, handle it now.
  let gesture;
  if (element[state$1].swipeDownWillCommit) {
    gesture = swipeDown;
  } else if (element[state$1].swipeLeftWillCommit) {
    gesture = swipeLeft;
  } else if (element[state$1].swipeRightWillCommit) {
    gesture = swipeRight;
  } else if (element[state$1].swipeUpWillCommit) {
    gesture = swipeUp;
  }
...
class Carousel extends Base$7 {
  ...
  [render$1](/** @type {ChangedFlags} */ changed) {
    if (changed.proxyListPartType && this[ids$1].proxyList) {
    ...
    if (changed.stagePartType || changed.orientation) {
      /** @type {any} */ const cast = this[ids$1].stage;
      if ("orientation" in cast) {
        cast.orientation = this[state$1].orientation;
      }
    }
    ...
    if (changed.orientation || changed.proxyListPartType) {
      /** @type {any} */ const cast = this[ids$1].proxyList;
      if ("orientation" in cast) {
        cast.orientation = this[state$1].orientation;
      }
    }
    ...
    if (changed.stagePartType) {
      this[ids$1].stage.removeAttribute("tabindex");
    }
  ...
  return class PlainArrowDirection extends Base {
    ...
    [render$1](/** @type {ChangedFlags} */ changed) {
      ...
      if (changed.orientation || changed.rightToLeft) {
        const { orientation, rightToLeft } = this[state$1];
        const vertical = orientation === "vertical";
        const transform = vertical
          ...
          ? "rotateZ(180deg)"
          : "";
        if (this[ids$1].arrowIconPrevious) {
          this[ids$1].arrowIconPrevious.style.transform = transform;
        }
        if (this[ids$1].arrowIconNext) {
          this[ids$1].arrowIconNext.style.transform = transform;
        }
      }
...
function ResizeMixin(Base) {
  return class Resize extends Base {
    ...
    [checkSize]() {
      ...
      const sizeChanged =
        clientHeight !== this[state$1].clientHeight ||
        clientWidth !== this[state$1].clientWidth;
      if (sizeChanged) {
        this[setState$1]({
          clientHeight,
          clientWidth,
 ...
 * @mixes TapCursorMixin
 */
class CenteredStrip extends Base$8 {
  get [defaultState$1]() {
    return Object.assign(super[defaultState$1], {
      currentItemRequired: true,
      orientation: "horizontal",
  ...
  [render$1](/** @type {ChangedFlags} */ changed) {
    ...
    if (
      ...
      const { orientation, rightToLeft, currentIndex } = this[state$1];
      ...
      // @ts-ignore
      const stripContainerDimension = this[ids$1].stripContainer[dimension];
      // @ts-ignore
      const stripDimension = this[ids$1].strip[dimension];
      ...
      if (stripDimension > 0) {
        ...
        const showTransition = this[state$1].enableEffects && !swiping;
        Object.assign(this[ids$1].strip.style, {
          transform,
          transition: showTransition ? "transform 0.25s" : "none",
        });

        this[ids$1].stripContainer.style.justifyContent = justifyContent;
      }
    }
    if (changed.items || changed.currentIndex) {
      // Apply `selected` style to the selected item only.
    ...
    if (changed.orientation) {
      const flexDirection =
        this[state$1].orientation === "horizontal" ? "" : "column";
      this[ids$1].stripContainer.style.flexDirection = flexDirection;
      this[ids$1].strip.style.flexDirection = flexDirection;
    }
  }
...
class PlainCenteredStripOpacity extends CenteredStrip {
  ...
  get transitionDuration() {
    return this[state$1].transitionDuration;
  }
  set transitionDuration(transitionDuration) {
    this[setState$1]({ transitionDuration });
  }
}
  ...
  return class PlainCarousel extends Base {
    ...
    [render$1](changed) {
      ...
      if (
        ...
        const { dark, detectDarkMode } = this[state$1];
        proxies.forEach((proxy) => {
...
function SelectableMixin(Base) {
  ...
  return class Selectable extends Base {
    ...
    set selected(selected) {
      ...
      this[setState$1]({ selected });
    }
  };
}

const Base$9 = SelectableMixin(Button);
 ...
 */
class SelectableButton extends Base$9 {}

const Base$a = DarkModeMixin(SelectableButton);
 ...
 * @mixes DarkModeMixin
 */
class PlainPageDot extends Base$a {
  [render$1](/** @type {ChangedFlags} */ changed) {
    super[render$1](changed);
